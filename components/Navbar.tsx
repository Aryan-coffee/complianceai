...
export default function Navbar() {
  ...
  const active = (href) => path === href ? "#4F8EF7" : "#94A3B8"
  ...
  return (
    <nav style={{ position:"fixed",top:0,left:0,right:0,zIndex:100,display:"flex",alignItems:"center",justifyContent:"space-between",padding:"0 2rem",height:64,background:"rgba(10,22,40,0.97)",backdropFilter:"blur(12px)",borderBottom:"1px solid rgba(255,255,255,0.08)" }}>
      ...
      <div style={{ display:"flex",alignItems:"center",gap:"1.5rem" }}>
        {user ? (
          <>
            <Link href="/dashboard" style={{ color:active("/dashboard"),textDecoration:"none",fontSize:14,fontWeight:500 }}>Dashboard</Link>
            <Link href="/compliance" style={{ color:active("/compliance"),textDecoration:"none",fontSize:14,fontWeight:500 }}>Check</Link>
            <Link href="/upload" style={{ color:active("/upload"),textDecoration:"none",fontSize:14,fontWeight:500 }}>Upload Doc</Link>
            <Link href="/chat" style={{ color:active("/chat"),textDecoration:"none",fontSize:14,fontWeight:500 }}>AI Chat</Link>
            <Link href="/regulations" style={{ color:active("/regulations"),textDecoration:"none",fontSize:14,fontWeight:500 }}>Regulations</Link>
          ...
          <>
            <Link href="/regulations" style={{ color:active("/regulations"),textDecoration:"none",fontSize:14 }}>Regulations</Link>
            <Link href="/pricing" style={{ color:active("/pricing"),textDecoration:"none",fontSize:14 }}>Pricing</Link>
